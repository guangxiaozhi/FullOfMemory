...
export function matchLeadingBlockCharacters(text) {
    ...
    let match = (_a = /^(\d+)(?:\.|\))\s/.exec(text)) === null || _a === void 0 ? void 0 : _a[0];
    ...
    if (!match) {
        ...
        match = (_b = /^[^a-zA-Z0-9]+\s{1}(?=[a-zA-Z0-9_*[!]|$)+/.exec(text)) === null || _b === void 0 ? void 0 : _b[0];
    }
    return match || "";
}
/**
...
function blockWrapIn(formattingText, state, dispatch) {
    ...
    if (dispatch) {
        ...
        const addedTextModifier = surroundingChar.length + formattingText.length;
...
export function insertCommonmarkLinkCommand(state, dispatch) {
    ...
    const dummyLink = (_a = globalThis.location.origin) !== null && _a !== void 0 ? _a : "url";
