 ...
 * @internal
 */
export declare class MenuView implements PluginView {
    dom: HTMLDivElement;
    private blocks;
    private view;
    private readonly;
 ...
 * @internal
 */
export declare function createMenuPlugin(blocks: MenuBlock[], containerFn: (view: EditorView) => Node, editorType: EditorType): Plugin;
