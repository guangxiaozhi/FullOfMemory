...
export class MenuView {
    constructor(blocks, view, editorType) {
        ...
        this.blocks = blocks
            ...
            return Object.assign(Object.assign({}, b), { entries, dom: blockDom });
        });
    ...
    checkAndUpdateMenuCommandState(entry, isReadonly, isFocused) {
        ...
        if ("children" in entry && ((_a = entry.children) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    makeBlockContainer(block) {
        ...
        dom.className = `s-editor-menu-block d-flex g2 ${(_b = (_a = block.classes) === null || _a === void 0 ? void 0 : _a.join(" ")) !== null && _b !== void 0 ? _b : ""} js-block-${block.name}`;
        return dom;
    }
    /**
    ...
    standardizeMenuItems(entries) {
        ...
        for (const entry of entries) {
            // TODO WRITE TEST
            if (!(entry === null || entry === void 0 ? void 0 : entry.key)) {
                continue;
            }
            let sanitizedEntry = Object.assign(Object.assign({}, entry), { 
                // check for an extended vs simple command
                commonmark: this.expandCommand(entry.commonmark), richText: this.expandCommand(entry.richText), display: null, children: null });
            if ("children" in entry && ((_a = entry.children) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    command(entry) {
        return this.editorType === EditorType.RichText
            ? entry === null || entry === void 0 ? void 0 : entry.richText
            : entry === null || entry === void 0 ? void 0 : entry.commonmark;
    }
    ...
    buildMenuDropdown(entry, display) {
        ...
        const command = Object.assign({}, this.command(entry));
        return {
            key: entry.key,
            display: wrapper,
...
MenuView.activeClass = "is-selected";
MenuView.invisibleClass = "d-none";
/**
