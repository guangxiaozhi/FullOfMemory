 ...
 */
type AddCodeBlockProcessorCallback = (content: string, container: Element) => boolean;
/**
 ...
 * @experimental
 */
export type EditorPlugin<TOptions = unknown> = (options: TOptions) => EditorPluginSpec;
/**
