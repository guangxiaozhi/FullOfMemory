...
const customMarkdownParserTokens = Object.assign(Object.assign({}, defaultMarkdownParser.tokens), { pre: { block: "pre" }, kbd: { mark: "kbd" }, sup: { mark: "sup" }, sub: { mark: "sub" }, html_inline: {
        node: "html_inline",
        getAttrs: (token) => ({
    ...
    stack_language_comment: { ignore: true }, stack_language_all_comment: { ignore: true }, bullet_list: {
        block: "bullet_list",
        getAttrs: (tok) => ({
    ...
    image: {
        ...
        getAttrs: (tok) => {
            ...
            if (tok.markup === "reference") {
                const meta = tok.meta;
                attrs.referenceType = (_c = meta === null || meta === void 0 ? void 0 : meta.reference) === null || _c === void 0 ? void 0 : _c.type;
                attrs.referenceLabel = (_d = meta === null || meta === void 0 ? void 0 : meta.reference) === null || _d === void 0 ? void 0 : _d.label;
            }
            return attrs;
        },
    }, tag_link: {
    ...
    if (token.getAttrs) {
        ...
        if (k === "link") {
            token.getAttrs = (tok, stream, index) => {
                var _a, _b;
                const attrs = Object.assign({}, origGetAttrs(tok, stream, index));
                attrs.markup = tok.markup;
                if (tok.markup === "reference") {
                    const meta = tok.meta;
                    attrs.referenceType = (_a = meta === null || meta === void 0 ? void 0 : meta.reference) === null || _a === void 0 ? void 0 : _a.type;
                    attrs.referenceLabel = (_b = meta === null || meta === void 0 ? void 0 : meta.reference) === null || _b === void 0 ? void 0 : _b.label;
                }
                return attrs;
            };
        }
        else {
            token.getAttrs = (tok, stream, index) => (Object.assign({ markup: tok.markup }, origGetAttrs(tok, stream, index)));
        }
        return;
    }
...
export function createDefaultMarkdownItInstance(features, externalPluginProvider) {
    ...
    externalPluginProvider === null || externalPluginProvider === void 0 ? void 0 : externalPluginProvider.alterMarkdownIt(defaultMarkdownItInstance);
...
export function buildMarkdownParser(features, schema, externalPluginProvider) {
    ...
    return new SOMarkdownParser(schema, defaultMarkdownItInstance, Object.assign(Object.assign({}, customMarkdownParserTokens), externalPluginProvider === null || externalPluginProvider === void 0 ? void 0 : externalPluginProvider.markdownProps.parser));
}
