...
.s-anchors.s-anchors__danger a:not(.s-link):hover:visited,
.s-anchors.s-anchors__default a:not(.s-link):hover:visited,
.s-anchors.s-anchors__grayscale a:not(.s-link):hover:visited,
.s-anchors.s-anchors__inherit a:not(.s-link):hover:visited,
.s-anchors.s-anchors__muted a:not(.s-link):hover:visited,
.s-anchors.s-anchors__danger .s-btn.s-btn__link:hover:visited,
.s-anchors.s-anchors__default .s-btn.s-btn__link:hover:visited,
.s-anchors.s-anchors__grayscale .s-btn.s-btn__link:hover:visited,
.s-anchors.s-anchors__inherit .s-btn.s-btn__link:hover:visited,
.s-anchors.s-anchors__muted .s-btn.s-btn__link:hover:visited,
.s-anchors.s-anchors__danger a:not(.s-link):active:visited,
.s-anchors.s-anchors__default a:not(.s-link):active:visited,
.s-anchors.s-anchors__grayscale a:not(.s-link):active:visited,
.s-anchors.s-anchors__inherit a:not(.s-link):active:visited,
.s-anchors.s-anchors__muted a:not(.s-link):active:visited,
.s-anchors.s-anchors__danger .s-btn.s-btn__link:active:visited,
.s-anchors.s-anchors__default .s-btn.s-btn__link:active:visited,
.s-anchors.s-anchors__grayscale .s-btn.s-btn__link:active:visited,
.s-anchors.s-anchors__inherit .s-btn.s-btn__link:active:visited,
...
.s-sidebarwidget:not(.s-anchors) a:not(.button):not(.post-tag):not(.s-btn):not(.s-sidebarwidget--action):not(.s-user-card--link),
.s-sidebarwidget:not(.s-anchors) a:not(.button):not(.post-tag):not(.s-btn):not(.s-sidebarwidget--action):not(.s-user-card--link):visited {
  color: var(--black-500);
}
